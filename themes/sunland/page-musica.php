		...
		<div class="[ wrapper ]">
			<div class="[ xmall-12 medium-8 ]">
				...
				<?php
					...
					$query_musica = new WP_Query( $musica_args );
					if ( $query_musica->have_posts() ) : while ( $query_musica->have_posts() ) : $query_musica->the_post();
		...
		<div class="[ wrapper ]">
			<div class="[ row ]">
				<div class="[ span xmall-12 ] [ padding ] [ text-center ][ center block ]">
					<h3 class="[ sub-title ] [ text-center ] [ inline-block align-middle ] [ padding ]">¿Tienes alguna duda sobre los talleres de música?</h2><div class="[ inline-block align-middle ][ text-center ][ padding ]"><a href="#" class="[ button button--medium button--highlight ][ padding ][ js-modal-opener ]" data-modal="natural-form">contáctanos</a></div>
				</div>
			</div>
		</div>
