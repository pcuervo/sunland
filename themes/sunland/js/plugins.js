...
;( function( $, window, undefined ) {
	...
	$('body').on('click', '.abrir-info', function(e) {
		e.preventDefault();
		$(this).parent().find('.evento-full').css( 'top', '0%' );
	});

	$('body').on('click', '.evento-full .custom-content-close', function(e) {
		e.preventDefault();
		$('.evento-full').css( 'top', '100%' );
	});

	// $('.cerrar-info').on('click', function(e)){
	// 	e.preventDefault();
